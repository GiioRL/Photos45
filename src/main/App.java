...
public class App extends Application {
    ...
    public static void saveData() {
        ...
        String dataFolder = System.getProperty("user.dir") + File.separator + "src" + File.separator + "data" + File.separator;
        for (User user: users) {
            try {
    ...
    public static void loadData() {
        File dataFolder = new File(System.getProperty("user.dir") + File.separator + "src" + File.separator + "data" + File.separator);
